...
const Hero = () => {
  return (
    <section id="home" className="min-h-[70vh] grid grid-cols-1 xl:grid-cols-8">
      {/* Information */}
      <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16">
        <div className="flex flex-col gap-8">
          <h1 className="text-5xl xl:text-7xl font-bold xl:leading-[7.5rem]">
            Cursos cooperativos de Programación!{" "}
          ...
          <p className="text-gray-500 text-2xl leading-[2.5rem]">
            Ayuda a la comunidad a aprender a programar, recibiendo asesorías con los mejores expertos
          </p>
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <button className="w-full xl:w-auto flex items-center justify-start text-left gap-4 py-2 px-8 rounded-xl text-xl">
              ...
              Mira nuestro <br /> video de intro
            </button>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="relative bg-white shadow-xl rounded-lg p-4 flex flex-col justify-center gap-2 max-w-[250px] mx-auto -mt-12">
            ...
            <div className="flex items-center gap-2 text-lg text-gray-500">
              <RiStarFill className="text-primary" /> 4.7 (1k Opiniones)
            </div>
